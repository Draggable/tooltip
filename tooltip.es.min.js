...
const _SmartTooltip = class _SmartTooltip {
  constructor(options = defaultOptions) {
    ...
    if (_SmartTooltip.instance) {
      _SmartTooltip.instance.destroy();
    }
  ...
  fitsInViewport(pos, tooltipRect) {
    const inViewport = pos.x >= 0 && pos.y >= 0 && pos.x + tooltipRect.width <= globalThis.innerWidth && pos.y + tooltipRect.height <= globalThis.innerHeight;
  ...
  destroy() {
    ...
    this.tooltip.remove();
    if (_SmartTooltip.instance === this) {
      _SmartTooltip.instance = null;
    }
  }
};
__publicField(_SmartTooltip, "instance", null);
let SmartTooltip = _SmartTooltip;
const Tooltip = SmartTooltip;
if (globalThis !== void 0) {
  globalThis.SmartTooltip = SmartTooltip;
}
export {
  SmartTooltip,
  Tooltip,
