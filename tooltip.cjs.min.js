...
"use strict";var t=Object.defineProperty,e=(e,i,s)=>((e,i,s)=>i in e?t(e,i,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[i]=s)(e,"symbol"!=typeof i?i+"":i,s);Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const i="_3x4ZIcu-",s="JIt36hCJ",o={triggerName:"tooltip"},n=class t{constructor(s=o){e(this,"triggerName"),e(this,"tooltip"),e(this,"activeTriggerType",null),e(this,"spacing",12),e(this,"handleClick",(t=>{const e=this.triggerName,i=t.target.closest(`[${e}][${e}-type="click"]`);if(i)if(this.isVisible())this.hide();else{const t=i.getAttribute(`${e}`);this.show(i,t),this.activeTriggerType="click"}else this.hide()})),e(this,"handleMouseOver",(t=>{const e=this.triggerName,i=t.target.closest(`[${e}]`);if("click"!==this.activeTriggerType&&"click"!==(null==i?void 0:i.getAttribute(`${e}-type`))){const t=null==i?void 0:i.getAttribute(`${e}`);t&&(this.show(i,t),this.activeTriggerType="hover")}})),e(this,"handleMouseOut",(t=>{const e=this.triggerName,i=t.target.closest(`[${e}]`);"click"!==this.activeTriggerType&&"click"!==(null==i?void 0:i.getAttribute(`${e}-type`))&&this.hide()})),e(this,"handleResize",(()=>{this.isVisible()&&this.hide()})),e(this,"handleScroll",(()=>{this.isVisible()&&this.hide()})),t.instance&&t.instance.destroy(),this.triggerName=`data-${s.triggerName}`,this.tooltip=document.createElement("div"),this.tooltip.className=`d-tooltip ${i}`,document.body.appendChild(this.tooltip),this.setupEventListeners(),t.instance=this}setupEventListeners(){document.addEventListener("mouseover",this.handleMouseOver),document.addEventListener("mouseout",this.handleMouseOut),document.addEventListener("touchstart",this.handleMouseOver),document.addEventListener("touchend",this.handleMouseOut),document.addEventListener("click",this.handleClick),globalThis.addEventListener("resize",this.handleResize),globalThis.addEventListener("scroll",this.handleScroll,!0)}isVisible(){return this.tooltip.classList.contains(s)}calculatePosition(t){const e=t.getBoundingClientRect(),i=this.tooltip.getBoundingClientRect(),s=[{name:"top",x:e.left+(e.width-i.width)/2,y:e.top-i.height-this.spacing},{name:"bottom",x:e.left+(e.width-i.width)/2,y:e.bottom+this.spacing},{name:"left",x:e.left-i.width-this.spacing,y:e.top+(e.height-i.height)/2},{name:"right",x:e.right+this.spacing,y:e.top+(e.height-i.height)/2},{name:"top-left",x:e.left,y:e.top-i.height-this.spacing},{name:"top-right",x:e.right-i.width,y:e.top-i.height-this.spacing},{name:"bottom-left",x:e.left,y:e.bottom+this.spacing},{name:"bottom-right",x:e.right-i.width,y:e.bottom+this.spacing}];return s.find((t=>this.fitsInViewport(t,i)))||s[0]}fitsInViewport(t,e){if(!(t.x>=0&&t.y>=0&&t.x+e.width<=globalThis.innerWidth&&t.y+e.height<=globalThis.innerHeight))return!1;return 0===[[t.x,t.y],[t.x+e.width,t.y],[t.x,t.y+e.height],[t.x+e.width,t.y+e.height],[t.x+e.width/2,t.y+e.height/2]].flatMap((([t,e])=>Array.from(document.elementsFromPoint(t,e)))).filter((t=>{if(this.tooltip.contains(t)||t===this.tooltip||t.classList.contains(i)||"none"===getComputedStyle(t).pointerEvents)return!1})).length}show(t,e){this.tooltip.innerHTML=e??"",this.tooltip.classList.add(s);const i=this.calculatePosition(t);this.tooltip.style.left=`${i.x}px`,this.tooltip.style.top=`${i.y}px`,this.tooltip.dataset.position=i.name}hide(){this.tooltip.classList.remove(s),this.activeTriggerType=null}destroy(){document.removeEventListener("mouseover",this.handleMouseOver),document.removeEventListener("mouseout",this.handleMouseOut),document.removeEventListener("touchstart",this.handleMouseOver),document.removeEventListener("touchend",this.handleMouseOut),document.removeEventListener("click",this.handleClick),globalThis.removeEventListener("resize",this.handleResize),globalThis.removeEventListener("scroll",this.handleScroll,!0),this.tooltip.remove(),t.instance===this&&(t.instance=null)}};e(n,"instance",null);let h=n;const l=h;void 0!==globalThis&&(globalThis.SmartTooltip=h),exports.SmartTooltip=h,exports.Tooltip=l,exports.default=h;
